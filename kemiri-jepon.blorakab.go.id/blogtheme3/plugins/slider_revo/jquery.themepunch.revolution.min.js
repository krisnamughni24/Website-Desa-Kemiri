...
(function (e, t) {
  ...
  function L(n, r) {
    ...
    if (f.data("kenburns") == "on") {
      _(n, r);
      TweenLite.set(n.find(".kenburnimg img"), { autoAlpha: 0 });
    }
    if (r.ie) {
    ...
    if (l == 12 || l == 13 || l == 14 || l == 15) {
      ...
      TweenLite.fromTo(
        B,
        X,
        { left: j, top: F, scale: U, opacity: I, rotation: r.rotate },
        {
          opacity: 1,
          rotation: 0,
          left: 0,
    ...
    if (l == 16) {
      ...
      TweenLite.fromTo(
        ...
        { scale: nt, rotation: Q, y: 0 - H - H / 4, ease: Power2.easeInOut }
      );
      setTimeout(function () {
      ...
      TweenLite.fromTo(
        ...
        { scale: rt, rotation: G, y: H + H / 4, ease: Power2.easeInOut }
      );
      TweenLite.fromTo(
        i.find(".tp-half-two"),
        N / 2e3,
      ...
      t.on("mousemove.hoverdir, mouseleave.hoverdir", function (n) {
        switch (n.type) {
          ...
          case "mouseleave":
            e(".tp-parallax-container").each(function () {
              var t = e(this);
              TweenLite.to(t, 0.4, { x: 0, y: 0, ease: Power3.easeOut });
            });
            break;
        }
      });
  ...
  function M(t, n) {
    ...
    e(".tp-parallax-container").each(function () {
      var t = e(this),
        n = parseInt(t.data("parallaxlevel"), 0) / 100,
        r = a * n;
      TweenLite.to(t, 0.2, { y: r, ease: Power3.easeOut });
    });
    if (n.parallaxBgFreeze != "on") {
      var f = n.parallaxLevels[0] / 100,
        l = a * f;
      TweenLite.to(t, 0.2, { y: l, ease: Power3.easeOut });
    }
  }
  function _(n, r) {
    try {
    ...
    n.find(".tp-caption").each(function (n) {
      ...
      if (c == 0) {
        ...
        if (!i) {
          ...
          q.ease = I.ease =
            l.data("easing") == t ? Power1.easeInOut : l.data("easing");
          I.data = new Object();
          I.data.oldx = I.x;
          I.data.oldy = I.y;
          q.data = new Object();
          ...
          l.find(".rs-pendulum").each(function () {
            ...
            if (n.data("timeline") == t) {
              ...
              (speed = n.data("speed") == t ? 2 : n.data("speed")),
                ...
                (easing =
                  n.data("ease") == t ? Power2.easeInOut : n.data("ease"));
              n.data("timeline").append(
                new TweenLite.fromTo(
                  n,
                  speed,
                  { rotation: r, transformOrigin: origin },
                  { rotation: i, ease: easing }
                )
              );
              n.data("timeline").append(
                new TweenLite.fromTo(
        ...
        if (r.stopLoop == "on" && r.next == r.lastslidetoshow - 1) {
          ...
          i.data(
            ...
            TweenLite.fromTo(
              ...
              r.delay / 1e3,
              { width: "0%" },
              { width: "100%", ease: Linear.easeNone, onComplete: o, delay: 1 }
            )
          );
        }
        if (r.hideTimerBar == "on") i.css({ visibility: "hidden" });
